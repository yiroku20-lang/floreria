...
const HERO_SLIDES: Slide[] = [
  {
    ...
    subtitle: 'Elige tu color favorito y regala un momento único.',
    tag: 'Colección de Temporada',
    // High-resolution tulip panorama matching user's photo with radiant yellow, coral, and pink tulips
    imageUrl: 'https://images.unsplash.com/photo-1520763185298-1b434c919102?auto=format&fit=crop&w=2000&q=85',
    ctaText: 'Ver Tulipanes',
    category: 'Tulipanes',
  },
  {
    id: 'slide-rosas',
    title: 'La elegancia de nuestras Rosas Velvet',
    subtitle: 'Ramos de autor creados con las rosas jardín más exclusivas y aromáticas.',
    tag: 'Edición Exclusiva',
    imageUrl: 'https://images.unsplash.com/photo-1561181286-d3fee7d55364?auto=format&fit=crop&w=2000&q=85',
    ctaText: 'Ver Rosas de Lujo',
    category: 'Rosas de Lujo',
  },
  {
    id: 'slide-autor',
    title: 'Diseños florales con alma artesanal',
    subtitle: 'Cada arreglo es una obra única diseñada a mano en nuestro taller botánico.',
    tag: 'Boutique Rosanfer',
