...
const HERO_SLIDES: Slide[] = [
  {
    id: 'slide-latidos',
    title: 'Latidos en Flor: Poesía y Romance',
    subtitle: 'Ramos de autor creados con las rosas rojas más selectas para expresar amor verdadero.',
    tag: 'Colección Romance',
    imageUrl: 'https://images.unsplash.com/photo-1561181286-d3fee7d55364?auto=format&fit=crop&w=2000&q=85',
    ctaText: 'Ver Latidos en Flor',
    category: 'Latidos en Flor',
  },
  {
    id: 'slide-primavera',
    title: 'Primavera Para Ti: Tulipanes & Frescura',
    subtitle: 'Elige tu color favorito y regala un amanecer fresco con tulipanes holandeses.',
    tag: 'Colección Primavera',
    imageUrl: 'https://images.unsplash.com/photo-1520763185298-1b434c919102?auto=format&fit=crop&w=2000&q=85',
    ctaText: 'Ver Primavera Para Ti',
    category: 'Primavera Para Ti',
  },
  {
    id: 'slide-festivos',
    title: 'Festivos: La Alegría de Celebrar',
    subtitle: 'Arreglos vibrantes para cumpleaños y quinceañeros que llenan de sonrisas cada rincón.',
    ...
    ctaText: 'Ver Festivos',
    category: 'Festivos',
  },
  {
    id: 'slide-nupcial',
    title: 'Set Nupcial "Sí Acepto"',
    subtitle: 'Diseños de novia exclusivos para bodas de ensueño en Cusco y el Valle Sagrado.',
